...
public:
	...
	void setPos(float x, float y) { _posicion.setXY(x, y); }
	void setVel(float vx, float vy) { _velocidad.setXY(vx, vy); }
	void setAcel(float ax, float ay) { _aceleracion.setXY(ax, ay); }
